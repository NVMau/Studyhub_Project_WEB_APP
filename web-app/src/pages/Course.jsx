...
import { getRegisteredCourses, getTeachingCourses } from "../services/userService";
            ...
            >
              ...
              <CardActions>
                <Button
                  variant="contained"
                  color="success"
                   onClick={() => navigate(`/lectures/${course.id}`)} // Điều hướng khi nhấn nút/ Điều hướng khi nhấn nút
                >
                  Xem khóa học
                </Button>
